...
=======
>>>>>>> a1860adda081ba4880d9e2a04d7612b6f4295c9d
...
chevronBtn.addEventListener("click", () => {
  ...
  header.classList.toggle("expanded", isSidebarExpanded);
  chevronBtn.querySelector("i").classList.toggle("fa-chevron-right", !isSidebarExpanded);
  chevronBtn.querySelector("i").classList.toggle("fa-chevron-left", isSidebarExpanded);
>>>>>>> a1860adda081ba4880d9e2a04d7612b6f4295c9d
});
...
<<<<<<< HEAD
      ...
      localStorage.setItem(
        "searchHistory",
        JSON.stringify(searchHistory.slice(-5))
...
<<<<<<< HEAD
  ...
  function filterContent(query) {
    ...
    recentlyPlayedGrid.innerHTML = albumItems
      .slice(0, 6)
      .map(
        (item) => `
            <div class="album-item">
      ...
      .join("");
    featuredArtistsGrid.innerHTML = albumItems
      .slice(0, 6)
      .map(
        (item) => `
            <div class="album-item">
      ...
      .join("");
    featuredAlbumsGrid.innerHTML = albumItems
      .map(
        (item) => `
            <div class="album-item">
                <img src="${item.image}" alt="Album Cover">
